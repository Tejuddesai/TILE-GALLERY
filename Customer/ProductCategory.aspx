<%@ Page Title="" Language="C#" MasterPageFile="~/Customer/CustomerPanel.master" AutoEventWireup="true" CodeFile="ProductCategory.aspx.cs" Inherits="Customer_ProductCategory" %>
        ...
        <tr>
            <td style="text-align: center">
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    SelectCommand="SELECT DISTINCT [CatName], [CatImage] FROM [Category]">
                </asp:SqlDataSource>
            </td>
        </tr>
    </table>
